...
export default function TopNavigationAccount() {
    ...
    return (
        <>
            {
                status === "authenticated" ? <div className={"flex justify-center items-center gap-2"}>
                    <Image src={session.pic} alt={""} className={"rounded-full"} width={48} height={48}/>
                ...
                </div> : <Button variant={"outlined"} href={"/signin"}>ورود به سایت</Button>
            }
        </>
    );
}
