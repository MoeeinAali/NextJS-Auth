...
import {Clock, Message, Phone} from "@/src/appclassbon/icons";
...
import {sendAuthCodeAction, verifyAction} from "@/src/app/_actions/sign-in-actions";
import {useRouter} from "next/navigation";
import Link from "next/link";
import {SimpleTimer} from "@/src/app/_components/general/simple-timer";
import {TimerRef} from "@/src/app/_types/general.types";
import {Loading} from "@/src/app/_components/general/loading";
import {useSlideUpStore} from "@/src/app/store/slide-up.store";
import {useNotificationStore} from "@/src/app/store/notifications.store";
import {getSession, useSession} from "next-auth/react";
import {startSignalRConnection} from "@/src/app/core/signalR-service";
        ...
        <div className="self-stretch">
            ...
            >
                ...
                <div className="flex items-center justify-between text-sm">
                    ...
                    <Link
                        className={`flex items-center  gap-2 relative ${showResendCode === false ? "text-secondary-600 pointer-events-none" : "text-white"}`}
